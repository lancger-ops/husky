...
> pycharm : 菜单栏 tools --> 选择Start SSH Session
...
> 设置pycharm项目启动地址为 192.168.56.11

> 启动服务

```shell script
linux-node1.example.com<2019-12-05 17:26:49> /data0/opt
root># python manage.py runserver 192.168.56.11:8000
Watching for file changes with StatReloader
Performing system checks...

System check identified no issues (0 silenced).
December 05, 2019 - 09:26:59
Django version 2.2.6, using settings 'husky.settings'
Starting development server at http://192.168.56.11:8000/
Quit the server with CONTROL-C.
```

## 其他

> 测试登录 http://192.168.56.11:8000/admin 输入账号密码 
